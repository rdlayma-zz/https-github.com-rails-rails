...
module Rails
  ...
  class Engine < Railtie
    ...
    initializer :set_load_path, before: :bootstrap_hook do |app|
      _all_load_paths(app.config.add_all_autoload_paths_to_load_path).reverse_each do |path|
    ...
    private
      ...
      def _all_load_paths(add_all_autoload_paths_to_load_path)
        @_all_load_paths ||= begin
          load_paths  = config.paths.load_paths
          load_paths += _all_autoload_paths if add_all_autoload_paths_to_load_path
        end.uniq
      end
